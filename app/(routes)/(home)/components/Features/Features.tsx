...
export function Features() {
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-40">
      <h3 className="text-2xl lg:text-6xl font-bold">Caracteristicas clave</h3>
      <p className="max-w-lg mt-5 lg:mt-10 lg:mb-16 text-xl">
      Nos preocupamos por la conformidad y la seguridad de nuestros clientes. Es por eso que brindamos el mejor servicio que puedas imaginar.
      </p>
